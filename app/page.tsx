...
export default async function Home() {
  ...
  const [statsRes, activeChallengesRes, initialProfilesRes] = await Promise.all([
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white selection:bg-lime-500 selection:text-white antialiased">
      ...
      <main className="flex flex-col">
        <Hero initialProfileCount={initialProfileCount} activeChallenge={initialActiveChallenge} />
