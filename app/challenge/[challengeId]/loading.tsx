...
export default function UserChallengeLoading() {
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 flex flex-col relative overflow-hidden">
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff02_1px,transparent_1px),gradient-to-bottom,#ffffff02_1px,transparent_1px] bg-[size:14px_24px] pointer-events-none" />
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-zinc-900/30 border border-white/5 rounded-3xl p-6 h-64 space-y-4">
              <div className="h-4 w-32 bg-zinc-800/60 rounded animate-pulse" />
              <div className="h-32 w-full bg-zinc-800/20 rounded-2xl animate-pulse" />
            </div>
          </div>
          <div>
            <SkeletonLeaderboard />
